...
src = partial(
    PipOption,
    '--branch_comparison', '--source', '--source-dir', '--source-directory',
    dest='src_dir',
    type='path',
    metavar='dir',
    ...
    'The default in a virtualenv is "<venv path>/branch_comparison". '
    'The default for global installs is "<current dir>/branch_comparison".'
)  # type: Callable[..., Option]
